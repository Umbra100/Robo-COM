...
WebClient.get(ConfigFile.clients.slack.oauth_redirect_path, async (req, res) => {
   ...
   console.log(terminalFormatter.bulletPoint,'Slack Client Access Sent, Reinstallation Complete');
   await res.send(`
      <!DOCTYPE html>
      <html lang="en">
      <head>
         ...
         <title>Reinstallation Successful!</title>
         <style>
            #container {
               ...
               padding: 4rem;
               border-radius: 10px;
               border: 5px solid #0980ff8d;
               background-color: #eaeaea;
            }
            #text {
               font: 600 45px Courier;
               text-align: center;
               border-top: 6px dashed #101010;
               width: fit-content;
               margin: auto;
               padding: 1rem;
            }
      ...
      <body>
         <div id = "container">
            <div id = "slackContainer">
               <svg height="100" width="400" class="c-slacklogo--white" viewBox="0 0 240 60" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision">
                  <title>Slack</title>
                  <g fill="none">
                     <path
            ...
            <div id="text">Reinstallation Successful!</div>
         </div>
      </body>
      </html>   
   `);
